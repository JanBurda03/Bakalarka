...
public record struct OrientedItem
{
    ...
    public OrientedItem(ItemProperties itemProperties, Orientation itemOrientation)
    {
...
public struct ItemToBePacked
{
    public OrientedItem Item;

    public WhereToPackHeuristics WhereToPackHeuristics;

    public ItemToBePacked(OrientedItem item, WhereToPackHeuristics whereToPackHeuristics)
    {
        Item = item;
        WhereToPackHeuristics = whereToPackHeuristics;
    }

    public PackedItem ToPackedItem(Coordinates coordinates, int ContainerID)
    {
