public class PackingVectorDecoder
{
    ...
    public PackingVectorDecoder(IPackingVectorPartDecoder<PlacementHeuristic> cellToHeuristicDecoder, IPackingVectorPartDecoder<Rotation> cellToRotationDecoder, IBoxToBePackedSorter boxSorter, PackingInput packingInput)
    {
    ...
    public static PackingVectorDecoder Create(PackingSetting packingSetting, PackingInput packingInput)
    {
        ...
        */
        ...
        return new PackingVectorDecoder(placementHeuristic, rotations, sorter, packingInput);
    }
}