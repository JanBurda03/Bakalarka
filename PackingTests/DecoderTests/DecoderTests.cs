...
public class DecoderTests
{
    ...
    public void DecoderTest()
    {
        ...
        var packingVector = PackingVector.CreateRandom(3);
            ...
            for (int a = 0; a < 2; a++)
            {
                ...
                for (int b = 0; b < 2; b++)
                {
                    ...
                    for (int c = 0; c < 2; c++)
                    {
                        ...
                        decoder = new PackingVectorDecoder(placementDecoder, rotationDecoder, boxToBePackedSorter, input);
