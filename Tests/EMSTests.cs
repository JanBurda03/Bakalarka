public class EmptyMaximalSpacesTests
{
    ...
    public void Test1()
    {
        ...
        var space = new Region(start, end);

        var ems = new EmptyMaximalSpaces(space);

        var allSpaces = ems.getEmptyMaximalSpaces(new Sizes(1, 1, 1)).ToList();
    ...
    public void Test2()
    {
        var s1 = new Region(new Coordinates(0, 0, 0), new Coordinates(5, 5, 5));
        var s2 = new Region(new Coordinates(0, 0, 0), new Coordinates(10, 10, 10));

        var ems = new EmptyMaximalSpaces(new List<Region> { s1, s2 });

        var fittingSpaces = ems.getEmptyMaximalSpaces(new Sizes(6, 6, 6)).ToList();
...
public class EmptyMaximalSpaceSpliterTests
{
    ...
    public void Test1()
    {
        var original = new Region(new Coordinates(0, 0, 0), new Coordinates(10, 10, 10));
        var occupied = new Region(new Coordinates(0, 0, 1), new Coordinates(5, 5, 5));
